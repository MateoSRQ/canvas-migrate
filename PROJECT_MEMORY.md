...
| `2026-09-13T12:08:00` | - | Antigravity | UI/Enhancement | Destacado visual del filtro de exclusión de secciones NO HABILITADO y confirmación en modal de exportación | `src/components/hierarchy/hierarchy-selector.tsx`, `src/components/hierarchy/modals/canvas-export-dialog.tsx`, `PROJECT_MEMORY.md` |
